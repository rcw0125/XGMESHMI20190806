<%@ Page Language="C#" AutoEventWireup="true" CodeFile="steelweight_product.aspx.cs" Inherits="BOF_steelweight_product" %>
...
<head id="Head1" runat="server">
    <title>无标题页</title>
    <link 
href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/def
ault.css"
...
<body>
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" 
bordercolor="#996633" cellpadding="0"
...
AutoPostBack="True" BackColor="#C0C0FF"
...
OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged" Width="50px">
                ...
                <td nowrap="nowrap" style="width: 40px; height: 10px; text-
align: center" width="52">
                    <span style="font-size: 11pt">
                    月</span></td>
                <td style="width: 40px; height: 10px">
                    <asp:DropDownList ID="ddlDay" runat="server" 
BackColor="#C0C0FF" Width="50px">
                        <asp:ListItem>1</asp:ListItem>
                    </asp:DropDownList></td>
                <td style="width: 24px; height: 10px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 231px; height: 10px; text-align: 
center"></td>
                <td style="width: 78px; height: 10px">
                    <asp:Button ID="btnQuery" runat="server" Height="24px" 
