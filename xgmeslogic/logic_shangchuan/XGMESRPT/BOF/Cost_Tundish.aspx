<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cost_Tundish.aspx.cs" Inherits="BOF_Cost_Tundish" %>
    ...
    <div>
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td nowrap="nowrap" style="width: 40px; height: 10px" width="52">
                ...
                <td style="width: 131px; height: 10px; text-align: center">
                    中包类型</td>
                <td style="width: 105px; height: 10px; text-align: center">
                    <asp:DropDownList ID="ddlTundishType" runat="server" BackColor="#C0C0FF" Width="104px">
                        <asp:ListItem Value="2">3#4#机中包</asp:ListItem>
                        <asp:ListItem Value="3">5#机中包</asp:ListItem>
                        <asp:ListItem Value="5">6#机中包</asp:ListItem>
                        <asp:ListItem Value="4">7#机中包</asp:ListItem>
                    </asp:DropDownList>&nbsp;</td>
                <td style="width: 90px; height: 10px; text-align: center">
                    价格类型</td>
                <td style="width: 112px; height: 10px; text-align: center">
                    <asp:DropDownList ID="ddlPriceType" runat="server" BackColor="#C0C0FF" Width="104px">
                        <asp:ListItem Value="1">最新预算价</asp:ListItem>
                        <asp:ListItem Value="2">月度预算价</asp:ListItem>
                        <asp:ListItem Value="3">年度预算价</asp:ListItem>
                    </asp:DropDownList></td>
                <td style="width: 86px; height: 10px">
                    &nbsp;<asp:Button ID="btnQuery" runat="server" Height="24px" OnClick="btnQuery_Click"
                        Text="查询" Width="72px" />
                </td>
            </tr>
        </table>
