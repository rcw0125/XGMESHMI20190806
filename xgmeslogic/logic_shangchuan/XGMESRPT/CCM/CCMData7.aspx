<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CCMData7.aspx.cs" Inherits="CCM_CCMData7" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:reportviewer id="ReportViewer1" runat="server" height="500px" width="800cm" Font-Names="Verdana" Font-Size="8pt" Visible="False">
            <LocalReport ReportPath="CCM\CCMData7.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="CCMData7_TC_ORIGINALDATA_NO7" />
                </DataSources>
            </LocalReport>
        </rsweb:reportviewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" InsertMethod="Insert"
            OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="CCMData7TableAdapters.TC_ORIGINALDATA_NO7TableAdapter">
            <InsertParameters>
