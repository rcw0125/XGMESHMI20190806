<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CCM_TFF_Refra.aspx.cs" Inherits="CCM_CCM_TFF_Refra" %>
...
<body>
    ...
    <div>
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            cellspacing="0" style="width: 98%; position: static; height: 1px">
            <tr>
                ...
                <td style="width: 93px; height: 28px; text-align: center">
                    <span style="font-size: 11pt"><span>铸机号</span>：</span></td>
                <td style="height: 28px; text-align: center">
        ...
        <cr:crystalreportviewer id="CrystalReportViewer1" runat="server" autodatabind="true"
              EnableDatabaseLogonPrompt="False" EnableDrillDown="False" EnableParameterPrompt="False" EnableTheming="False"></cr:crystalreportviewer>
    </form>
</body>
</html>
