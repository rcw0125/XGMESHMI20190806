<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cost_Ladle.aspx.cs" Inherits="BOF_Cost_Ladle" %>
        ...
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 131px; height: 10px; text-align: center">
                    钢包类型</td>
                <td style="width: 105px; height: 10px; text-align: center"><asp:DropDownList ID="ddlLadleType" runat="server" BackColor="#C0C0FF" Width="104px">
                    <asp:ListItem Value="1">50T常规钢包</asp:ListItem>
                    <asp:ListItem Value="2">50T精练钢包</asp:ListItem>
                    <asp:ListItem Value="3">80T精练钢包</asp:ListItem>
                </asp:DropDownList>&nbsp;</td>
                <td style="width: 90px; height: 10px; text-align: center">
                    价格类型</td>
                <td style="width: 112px; height: 10px; text-align: center"><asp:DropDownList ID="ddlPriceType" runat="server" BackColor="#C0C0FF" Width="104px">
