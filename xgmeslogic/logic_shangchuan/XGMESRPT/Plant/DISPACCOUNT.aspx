<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DISPACCOUNT.aspx.cs" Inherits="Plant_DISPACCOUNT" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                <td style="width: 40px; height: 14px; text-align: center">
                ...
                <td style="width: 16px; height: 14px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 128px; height: 14px; text-align: center"><asp:DropDownList ID="ddlDISPACCOUNT" runat="server" BackColor="#C0C0FF" Width="106px">
                    <asp:ListItem Value="1">堵流</asp:ListItem>
                    <asp:ListItem Value="2">断浇</asp:ListItem>
                    <asp:ListItem Value="3">回炉</asp:ListItem>
                    <asp:ListItem Value="4">溢钢</asp:ListItem>
                    <asp:ListItem Value="5">漏钢</asp:ListItem>
                </asp:DropDownList>
                </td>
