<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BLOOMCOSTCON.aspx.cs" Inherits="Plant_BLOOMCOSTCON" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                <td style="width: 40px; height: 17px; text-align: center">
                ...
                <td style="height: 17px; text-align: center" width="40">
                    <span style="font-size: 11pt">
                    年</span></td>
                <td style="width: 40px; height: 17px">
                ...
                <td nowrap="nowrap" style="width: 40px; height: 17px; text-align: center" width="52">
                    <span style="font-size: 11pt">
                    月</span></td>
                <td style="width: 40px; height: 17px">
                    <asp:DropDownList ID="ddlDay" runat="server" BackColor="#C0C0FF" Width="50px">
                    </asp:DropDownList></td>
                <td style="width: 24px; height: 17px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 130px; height: 17px; text-align: center"><asp:DropDownList ID="ddlBloomCostcon" runat="server" BackColor="#C0C0FF" Width="120px">
                    <asp:ListItem Value="A">综合表</asp:ListItem>
                    <asp:ListItem Value="F">常规钢</asp:ListItem>
                    <asp:ListItem Value="P">老系统精炼钢</asp:ListItem>
                    <asp:ListItem Value="J">大方坯（综合）</asp:ListItem>
                    <asp:ListItem Value="R">大方坯（经过RH）</asp:ListItem>
                </asp:DropDownList>
                </td>
                <td style="width: 95px; height: 17px; text-align: center">
                </td>
