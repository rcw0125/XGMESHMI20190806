<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alloy_cost.aspx.cs" Inherits="Plant_TEST_AUGUST1ST" %>
        ...
        <table align="center" bgcolor="#00cccc" border="1" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 24px; height: 17px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 130px; height: 17px; text-align: center">
                    <asp:DropDownList ID="ddalloy_cost" runat="server">
                        <asp:ListItem Value="0">合金成本日报</asp:ListItem>
                        <asp:ListItem Value="1">合金成本月报</asp:ListItem>
                    </asp:DropDownList>&nbsp;</td>
