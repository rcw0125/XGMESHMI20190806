<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Steel.aspx.cs" Inherits="SteelWeight_Steel" %>
        ...
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 93px; height: 28px; text-align: center">
                    ...
                    <span>炉座号</span>：</span></td>
                <td style="height: 28px; text-align: center">
                    <asp:DropDownList ID="ddLBOFID" runat="server" BackColor="#C0C0FF">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem Value="1">1#炉</asp:ListItem>
                        <asp:ListItem Value="2">2#炉</asp:ListItem>
                        <asp:ListItem Value="3">3#炉</asp:ListItem>
                        <asp:ListItem Value="4">4#炉</asp:ListItem>
                    </asp:DropDownList></td>
