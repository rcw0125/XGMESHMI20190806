<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IroneEleMonitor.aspx.cs" Inherits="Quality_IroneEleMonitor" %>
    ...
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td nowrap="nowrap" style="width: 27px; height: 14px; text-align: center">
                    <asp:DropDownList ID="ddlTENDAYSNUM" runat="server" BackColor="#C0C0FF" Width="59px" OnSelectedIndexChanged="ddlTENDAYSNUM_SelectedIndexChanged">
                        <asp:ListItem></asp:ListItem>
                        <asp:ListItem Value="1">上旬</asp:ListItem>
                        <asp:ListItem Value="2">中旬</asp:ListItem>
                        <asp:ListItem Value="3">下旬</asp:ListItem>
                    </asp:DropDownList></td>
                <td style="width: 26px; height: 14px; text-align: center">
                    &nbsp;</td>
