<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sbdjyb.aspx.cs" Inherits="sbdjyb" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="118px" 
                      ...
                      <asp:ListItem Value="0">请选择车间</asp:ListItem>
                     <asp:ListItem Value="17">连铸维修车间</asp:ListItem>
                    <asp:ListItem Value="18">冶炼维修车间</asp:ListItem>
                    <asp:ListItem Value="13">运行车间</asp:ListItem> 
                    <asp:ListItem Value="7">脱硫车间</asp:ListItem>      
                    <asp:ListItem Value="8">冶炼一车间</asp:ListItem>           
                    <asp:ListItem Value="9">冶炼二车间</asp:ListItem>
                    <asp:ListItem Value="10">精炼车间</asp:ListItem>
                    <asp:ListItem Value="11">连铸车间</asp:ListItem>
                    <asp:ListItem Value="6">设备科</asp:ListItem>
                    <asp:ListItem Value="4">生产科</asp:ListItem>
                    <asp:ListItem Value="5">质量技术科</asp:ListItem>
                   <%-- <asp:ListItem Value="2">综合办</asp:ListItem>--%>
                    <asp:ListItem Value="3">安环科</asp:ListItem>
                    
                    
                    
                    
                    
                    <asp:ListItem Value="14">无锡东方</asp:ListItem>
                    <asp:ListItem Value="16">精益办</asp:ListItem>
                   
                    </asp:DropDownList>
                </td>
                <td class="style3">
                    <asp:DropDownList ID="DdlBz" runat="server" Height="24px" Width="224px">
                     <asp:ListItem Value="0">请选择班组</asp:ListItem>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="778px" 
            ...
            <LocalReport ReportPath="Quality\sbdjyb.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
