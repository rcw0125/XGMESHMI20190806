<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmPlantDaily.aspx.cs" Inherits="Quality_frmPlantDaily" %>
    ...
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td nowrap="nowrap" style="width: 40px; height: 14px; text-align: center" width="52">
                    <span style="font-size: 11pt">
                    月</span></td>
                <td style="width: 40px; height: 14px">
                    <asp:DropDownList ID="ddlDay" runat="server" BackColor="#C0C0FF" Width="50px">
                    </asp:DropDownList></td>
                <td style="width: 24px; height: 14px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 231px; height: 14px; text-align: center">
                </td>
