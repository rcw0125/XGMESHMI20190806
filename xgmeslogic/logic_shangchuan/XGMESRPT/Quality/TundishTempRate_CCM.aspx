<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TundishTempRate_CCM.aspx.cs" Inherits="Quality_Waste" %>
        ...
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 82px; height: 13px; text-align: center"><asp:DropDownList ID="Quality" runat="server" BackColor="#C0C0FF" Width="205px">
                    <asp:ListItem Value="3">炼钢厂LF炉中包温度合格率报表</asp:ListItem>
...
&nbsp;<rsweb:reportviewer id="ReportViewer1" runat="server" font-names="Verdana" font-size="8pt"
            ...
            <LocalReport ReportPath="Quality\CCMTundishTempRate_CCM.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="dsLF_TUNDISH_TEMP" />
                </DataSources>
            </LocalReport>
        </rsweb:reportviewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" TypeName="dsLF_TUNDISH_TEMPTableAdapters.TQ_TUNDISH_TEMP_RATETableAdapter" InsertMethod="Insert">
            <InsertParameters>
                <asp:Parameter Name="LOGTIME" Type="String" />
                <asp:Parameter Name="UNITID" Type="String" />
                <asp:Parameter Name="TEAM" Type="String" />
                <asp:Parameter Name="PRO_TOTAL_D" Type="Decimal" />
                <asp:Parameter Name="p1" Type="Decimal" />
                <asp:Parameter Name="PRO_TUNTEMP_RATE_D" Type="Decimal" />
                <asp:Parameter Name="PRO_TOTAL_M" Type="Decimal" />
                <asp:Parameter Name="p4" Type="Decimal" />
                <asp:Parameter Name="PRO_TUNTEMP_RATE_M" Type="Decimal" />
            </InsertParameters>
