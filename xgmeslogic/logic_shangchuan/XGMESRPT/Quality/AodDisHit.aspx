<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AodDisHit.aspx.cs" Inherits="AodDisHit" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td style="width: 231px; height: 10px; text-align: center">
                    <asp:DropDownList ID="Quality" runat="server">
                        ...
                        <asp:ListItem Value="1">不锈钢内控成分</asp:ListItem>
                    </asp:DropDownList></td>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="778px" 
            ...
            <LocalReport ReportPath="Quality\AodDisHitEle.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
