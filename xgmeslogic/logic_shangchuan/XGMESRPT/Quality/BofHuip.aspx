<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BofHuip.aspx.cs" Inherits="BofHuip" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td style="width: 231px; height: 10px; text-align: center">
                    <asp:DropDownList ID="Quality" runat="server">
                        ...
                        <asp:ListItem Value="1">转炉回磷率指标报表</asp:ListItem>
                    </asp:DropDownList></td>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="778px" 
            ...
            <LocalReport ReportPath="Quality\BofHuiP_Rate.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
