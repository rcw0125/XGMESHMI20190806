<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOFEleDisQuality.aspx.cs" Inherits="Quality_BOFEleDisQuality" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td style="width: 231px; height: 10px; text-align: center">
                    <asp:DropDownList ID="Quality" runat="server">
                        <asp:ListItem Value="0">转炉进站成份不合台帐</asp:ListItem>
                        <asp:ListItem Value="1">转炉进站成份不合明细</asp:ListItem>
                    </asp:DropDownList></td>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="778px" Visible="False" Width="2278px" Font-Names="Verdana" Font-Size="8pt" SizeToReportContent="True">
        </rsweb:ReportViewer>
        ...
        <%--<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
            TypeName="dsBOFEleDisQualityDetailTableAdapters.TQ_BOF_ELE_DISQUALITY_DETAILTableAdapter" OldValuesParameterFormatString="original_{0}">
            </asp:ObjectDataSource>--%>
