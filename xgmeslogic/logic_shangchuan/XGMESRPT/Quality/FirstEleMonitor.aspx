<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FirstEleMonitor.aspx.cs" Inherits="Quality_FirstEleMonitor" %>
    ...
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 26px; height: 14px; text-align: center"><asp:DropDownList ID="ddlDISPACCOUNT" runat="server" BackColor="#C0C0FF" Width="215px">
                    <asp:ListItem Value="1">1#转炉品种钢进站成分质量报表</asp:ListItem>
                    <asp:ListItem Value="2">2#转炉品种钢进站成分质量报表</asp:ListItem>
                    <asp:ListItem Value="3">3#转炉品种钢进站成分质量报表</asp:ListItem>
                    <asp:ListItem Value="4">4#转炉品种钢进站成分质量报表</asp:ListItem>
