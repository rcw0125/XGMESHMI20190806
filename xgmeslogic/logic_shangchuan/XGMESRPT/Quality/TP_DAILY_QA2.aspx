<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TP_DAILY_QA2.aspx.cs" Inherits="Quality_TP_DAILY_QA2" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                <td style="width: 40px; height: 12px; text-align: center">
                ...
                <td style="height: 12px; text-align: center" width="40">
                    <span style="font-size: 11pt">
                    年</span></td>
                <td style="width: 40px; height: 12px">
                ...
                <td nowrap="nowrap" style="width: 40px; height: 12px; text-align: center" width="52">
                    <span style="font-size: 11pt">
                    月</span></td>
                <td style="width: 40px; height: 12px">
                    <asp:DropDownList ID="ddlDay" runat="server" BackColor="#C0C0FF" Width="50px">
                    </asp:DropDownList></td>
                <td style="width: 24px; height: 12px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 231px; height: 12px; text-align: center">
                </td>
