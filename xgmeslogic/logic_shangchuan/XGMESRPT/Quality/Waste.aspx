<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Waste.aspx.cs" Inherits="Quality_Waste" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 82px; height: 13px; text-align: center"><asp:DropDownList ID="Quality" runat="server" BackColor="#C0C0FF" Width="205px">
                    <asp:ListItem Value="3">炼钢厂甩废明细表分布质量日报</asp:ListItem>
        ...
        <rsweb:reportviewer id="ReportViewer1" runat="server" font-names="Verdana" font-size="8pt"
            ...
            <LocalReport ReportPath="Quality\WasteInfo.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" TypeName="dsWasteTableAdapters.TQ_WASTE_INFOTableAdapter">
            <InsertParameters>
