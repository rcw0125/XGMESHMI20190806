<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LFSteelGradeMonitor.aspx.cs" Inherits="Quality_LFSteelGradeMonitor" %>
...
<body>
    <form id="form1" runat="server">
        <table align="center" bgcolor="#00cccc" border="1" cellpadding="0"
            ...
            <tr>
                <td style="width: 40px; height: 8px; text-align: center">
                    <span style="font-size: 11pt">
                    日期:</span></td>
                <td style="width: 40px; height: 8px">
                ...
                <td style="height: 8px; text-align: center" width="40">
                    <span style="font-size: 11pt">
                    年</span></td>
                <td style="width: 40px; height: 8px">
                ...
                <td nowrap="nowrap" style="width: 40px; height: 8px; text-align: center" width="52">
                    <span style="font-size: 11pt">
                    月</span></td>
                <td style="width: 40px; height: 8px">
                    <asp:DropDownList ID="ddlDay" runat="server" BackColor="#C0C0FF" Width="50px">
                    </asp:DropDownList></td>
                <td style="width: 24px; height: 8px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 231px; height: 8px; text-align: center">
                </td>
