<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOFVarSteelIndicator.aspx.cs" Inherits="Quality_BOFVarSteelIndicator" %>
        ...
        <table align="center" bgcolor="#00cccc" border="1"  cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 24px; height: 7px; text-align: center">
                    <span style="font-size: 11pt">
                    日</span></td>
                <td style="width: 231px; height: 7px; text-align: center">
                </td>
