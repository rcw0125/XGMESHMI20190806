<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BOF_Matconsume_D.aspx.cs" Inherits="BOF_BOF_Matconsume" %>
            ...
            <table align="center" bgcolor="#00cccc" border="1" bordercolor="#996633" cellpadding="0"
                ...
                <tr>
                    ...
                    <td style="width: 24px; height: 28px; text-align: center">
                        <span style="font-size: 11pt">
                        日</span></td>
                    <td style="width: 73px; height: 28px; text-align: center"><asp:DropDownList ID="Quality" runat="server" BackColor="#C0C0FF" Width="139px">
                        <asp:ListItem Value="0">转炉辅料消耗月报</asp:ListItem>
                        <asp:ListItem Value="1">转炉辅料消耗日报</asp:ListItem>
                    </asp:DropDownList></td>
