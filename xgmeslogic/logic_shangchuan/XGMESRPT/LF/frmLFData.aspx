<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLFData.aspx.cs" Inherits="LF_frmLFData" %>
...
<body>   
            ...
            <tr>
                ...
                <td style="width: 4px; height: 18px; text-align: center">
                    ...
                    <asp:DropDownList ID="Quality" runat="server" BackColor="#C0C0FF" Width="50px">
                        ...
                        <asp:ListItem Value="1">1#LF炉</asp:ListItem>
                        <asp:ListItem Value="2">2#LF炉</asp:ListItem>
                        <asp:ListItem Value="3">3#LF炉</asp:ListItem>
                        <asp:ListItem Value="4">4#LF炉</asp:ListItem>
                        <asp:ListItem Value="5">5#LF炉</asp:ListItem>
                    </asp:DropDownList></td>
                <td style="width: 26px; height: 18px; text-align: center">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
        ...
        <rsweb:ReportViewer ID="ReportViewer1"  runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="LF\rptLFData.rdlc" EnableExternalImages="True">
                <DataSources>
