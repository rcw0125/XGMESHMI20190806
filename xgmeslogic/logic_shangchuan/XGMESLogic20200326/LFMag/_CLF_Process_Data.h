...
public:
	...
	/// <Property class="CLF_Process_Data" name="Lid_Life" type="L3LONG">
	/// 炉盖寿命
	/// </Property>
	...
	/// <Property class="CLF_Process_Data" name="PoleConsume" type="L3LONG">
	/// 电极消耗
	/// </Property>
	...
	/// <Property class="CLF_Process_Data" name="Slag_Thickness" type="L3LONG">
	/// 渣层厚度(不锈钢)
	/// </Property>
	DECLARE_L3PROP_LONG(Slag_Thickness)

	/// <Property class="CLF_Process_Data" name="HoldBack_Time" type="L3LONG">
	/// 钢包净空
	/// </Property>
	DECLARE_L3PROP_FLOAT(LadleJk)
