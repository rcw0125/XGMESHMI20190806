...
public:
	...
	/// <Property class="CLadle_Use" name="Auto_Flow" type="L3LONG">
	/// 
	/// 是否自动下流
	/// 
	/// </Property>
	DECLARE_L3PROP_LONG(Auto_Flow)

    /// <Property class="CLadle_Use" name="time_After_Steel" type="L3DOUBLE">
	/// 钢包过钢时间
	/// </Property>
	DECLARE_L3PROP_DOUBLE(Time_After_Steel)

	/// <Property class="CLadle_Use" name="WorkStation" type="L3STRING">
	/// 工作位
	/// </Property>
	DECLARE_L3PROP_STRING(WorkStation)

	/// <Property class="CLadle_Use" name="Cd_Temp" type="L3LONG">
	/// C/D类钢包温度
	/// </Property>
	DECLARE_L3PROP_LONG(Cd_Temp)

	/// <Property class="CLadle_Use" name="Casting_Stop_Time" type="L3DATETIME">
	/// 本炉次停浇时间
	/// </Property>
	DECLARE_L3PROP_DATETIME(Casting_Stop_Time)

	/// <Property class="CLadle_Use" name="SlagWire" type="L3STRING">
	/// 渣线及其他情况
	/// </Property>
	DECLARE_L3PROP_STRING(SlagWire)

	/// <Property class="CLadle_Use" name="Wall_Temp" type="L3LONG">
	/// 出钢前包壁温度
	/// </Property>
	DECLARE_L3PROP_LONG(Wall_Temp)

    /// <Property class="CLadle_Use" name="Time_Ladle_Casting" type="L3LONG">
	/// 引流沙过钢时间
	/// </Property>
	DECLARE_L3PROP_DOUBLE(Time_Ladle_Casting)

	/// <Property class="CLadle_Use" name="Dump_Ladleid" type="L3LONG">
	/// 未知
	/// </Property>
	DECLARE_L3PROP_STRING(Dump_Ladleid)
