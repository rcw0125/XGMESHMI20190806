...
BEGIN_L3PROPTABLE(CLadle_Use,CL3Object)
	...
	L3PROP_LONG(Auto_Flow)
	L3PROP_DOUBLE(Time_After_Steel)
	L3PROP_STRING(WorkStation)
	L3PROP_LONG(Cd_Temp)
	L3PROP_DATETIME(Casting_Stop_Time)
	L3PROP_STRING(SlagWire)
	L3PROP_LONG(Wall_Temp)
	L3PROP_DOUBLE(Time_Ladle_Casting)
	L3PROP_STRING(Dump_Ladleid)
