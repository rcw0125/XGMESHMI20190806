...
BEGIN_L3METHODMAP(CAOD_Unit_Mag,ProduceUnit)
	...
	L3_METHOD(CAOD_Unit_Mag,"DesignateSteel",0,DesignateSteel,L3VT_BOOL,L3VTS_RECORDSET)
	L3_METHOD(CAOD_Unit_Mag,"SteelArrived",0,SteelArrived,L3VT_BOOL,L3VTS_NONE)
