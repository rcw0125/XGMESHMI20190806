...
BEGIN_L3PROPTABLE(CCCM_Process_Data,CL3Object)
	...
	L3PROP_STRING(SpeedChange_Reason)
	L3PROP_STRING(SpeedChange_Detailed)
	L3PROP_STRING(Soft_Press_Change)
	L3PROP_STRING(Soft_Press_Detailed)
	L3PROP_STRING(Soft_Press_Reason)
	L3PROP_LONG(Before_Casting_Tundish_Temp)
	L3PROP_LONG(Before_Casting_Shuikou_Temp1)
	L3PROP_LONG(Before_Casting_Shuikou_Temp2)
	L3PROP_LONG(Before_Casting_Shuikou_Temp3)
	L3PROP_LONG(Before_Casting_Shuikou_Temp4)
