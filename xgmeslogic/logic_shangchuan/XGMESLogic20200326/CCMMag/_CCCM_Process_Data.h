...
public:
	...
	/// <Property class="CCCM_Process_Data" name="SpeedChange_Reason" type="L3STRING">
	/// 拉速改变原因 
	/// </Property>
	DECLARE_L3PROP_STRING(SpeedChange_Reason)

	/// <Property class="CCCM_Process_Data" name="SpeedChange_Detailed" type="L3STRING">
	/// 改变拉速详细备注 
	/// </Property>
	DECLARE_L3PROP_STRING(SpeedChange_Detailed)

	/// <Property class="CCCM_Process_Data" name="Soft_Press_Change" type="L3STRING">
	/// 轻压下是否投入 
	/// </Property>
	DECLARE_L3PROP_STRING(Soft_Press_Change)
    
	/// <Property class="CCCM_Process_Data" name="Soft_Press_Detailed" type="L3STRING">
	/// 轻压下未投入情况
	/// </Property>
	DECLARE_L3PROP_STRING(Soft_Press_Detailed)

	/// <Property class="CCCM_Process_Data" name="Soft_Press_Reason" type="L3STRING">
	/// 轻压下未投入原因 
	/// </Property>
	DECLARE_L3PROP_STRING(Soft_Press_Reason)
    
	/// <Property class="CCCM_Process_Data" name="before_Casting_Tundish_Temp" type="L3LONG">
	/// 开浇前中包温度[℃]
	/// </Property>
	DECLARE_L3PROP_LONG(Before_Casting_Tundish_Temp)

	/// <Property class="CCCM_Process_Data" name="Before_Casting_Shuikou_Temp1" type="L3LONG">
	/// 开浇前水口温度[℃]1
	/// </Property>
	DECLARE_L3PROP_LONG(Before_Casting_Shuikou_Temp1)

	/// <Property class="CCCM_Process_Data" name="Before_Casting_Shuikou_Temp2" type="L3LONG">
	/// 开浇前水口温度[℃]2
	/// </Property>
	DECLARE_L3PROP_LONG(Before_Casting_Shuikou_Temp2)

	/// <Property class="CCCM_Process_Data" name="Before_Casting_Shuikou_Temp3" type="L3LONG">
	/// 开浇前水口温度[℃]3
	/// </Property>
	DECLARE_L3PROP_LONG(Before_Casting_Shuikou_Temp3)

	/// <Property class="CCCM_Process_Data" name="Before_Casting_Shuikou_Temp4" type="L3LONG">
	/// 开浇前水口温度[℃]4
	/// </Property>
	DECLARE_L3PROP_LONG(Before_Casting_Shuikou_Temp4)
