...
public:
	...
	/// </Method>
	L3LONG GenCastingPlanOfSpecifyCasterID(CString csCasterID,CString csMaterialCode,L3RECORDSET rsPlanOrder,L3LONG nHeatCount,CString csSteelGradeIndex,L3DOUBLE fWeight,L3SHORT nBOFFlag);
	...
	/// </Method>
	 ...
	 /// </Method>
	 L3LONG GetHeatMaxProcessNo(L3SHORT nUnitType, CString csUnitID,CString csAodID);
	...
	/// <Method class="CPlan_Mag" name="TappingPlanGen1" type="L3LONG">
	/// 
	/// 编制不锈钢出钢计划，更改订单，浇钢计划的状态为4已排产，新生成的出钢计划状态为1未下达
	/// ARG&gt;&gt; rsCastingPlan : 计划数据。必须包含PlanID字段。
	/// RET &lt;&lt; 成功返回TRUE；失败返回出错代码。
	/// <Param name="rsCastingPlan" type="L3RECORDSET"></Param>
	/// </Method>
	L3LONG TappingPlanGen1(L3RECORDSET rsCastingPlan1);

	/// <Method class="CPlan_Mag" name="NewCastingPlanGen1" type="L3LONG">
	/// 
	/// 新编制不锈钢铸机浇钢计划，更改订单的状态为3生成浇钢计划，浇钢计划的状态为1未排产
	/// ARG&gt;&gt; rsPlan :订单记录，csSteelGradeIndex：炼钢记号。
	/// RET &lt;&lt; 成功返回TRUE；失败返回FALSE。
	/// <Param name="rsPlan" type="L3RECORDSET"></Param>
	/// <Param name="strSteelGradeIndex" type="String"></Param>
	L3LONG NewCastingPlanGen1(L3RECORDSET rsPlan,L3STRING strSteelGradeIndex);

	/// <Method class="CPlan_Mag" name="GenCastingPlanOfSpecifyCasterID1" type="L3LONG">
	/// 
	/// 生成指定不锈钢铸机铸机浇钢计划
	/// ARG&gt;&gt; csCasterID : 铸机。
	/// rsPlanOrder:计划订单信息
	...
	/// <Param name="csSteelGradeIndex" type="CSTRING">炼钢记号</Param>
	/// </Method>
	L3LONG GenCastingPlanOfSpecifyCasterID1(CString csCasterID,CString csMaterialCode,L3RECORDSET rsPlanOrder,L3LONG nHeatCount,CString csSteelGradeIndex,L3DOUBLE fWeight,L3SHORT nBOFFlag,L3LONG nAodType);

	/// <Method class="CPlan_Mag" name="CalculateCastingTime1" type="L3LONG">
	/// 计算不锈钢浇钢计划铸机开浇时间
	/// ARG&gt;&gt; csCasterID : 铸机。
	/// ARG&gt;&gt; csSteelGradeIndex : 炼钢记号。
	/// ARG&gt;&gt; &dtCastingTime : 开浇时间。
	...
	/// <Param name="csSteelGradeIndex" type="CSTRING">炼钢记号</Param>
	/// </Method>
	L3LONG CalculateCastingTime1(CString csCasterID,CString csSteelGradeIndex,L3DATETIME &dtCastingTime);

	/// <Method class="CPlan_Mag" name="CalculateHeatCount1" type="L3LONG">
	/// 
	/// 计算不锈钢炉数
	/// ARG&gt;&gt; nBOFFlag : 转炉标志。
	/// dWeight:计划订单重量
	...
	/// <Param name="dWeight" type="L3DOUBLE">计划订单重量</Param>
	/// </Method>
	L3LONG  CalculateHeatCount1(L3SHORT nBOFFlag,L3DOUBLE dWeight);
