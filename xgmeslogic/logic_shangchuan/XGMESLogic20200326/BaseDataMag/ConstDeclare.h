...
const CString STORE_ID_SCRAP_PCACHE1	= _T("S84P01");	//炼钢厂废钢生铁原料二库入库缓存
const CString STORE_ID_SCRAP1		= _T("S84");	//炼钢厂废钢生铁原料二库
const CString STORE_ID_SCRAP_CACHE1	= _T("S84N01");	//炼钢厂废钢生铁原料二库出库缓存
...
const CString QA_CCM_STD_BASE_CLASS_URI		        = _T("XGMESLogic\\QualityMag\\CQA_Cater_Std_Base");
...
//熔化炉工序管理类
const CString MELT_CLASS_URI = _T("XGMESLogic\\MELTMag\\CMELT_Unit_Mag");
//熔化炉工序实绩类
const CString MELT_BASE_DATA_CLASS_URI		= _T("XGMESLogic\\MELTMag\\CMELT_Base_Data"); // 转炉炉次基本数据
const CString MELT_FEED_DATA_CLASS_URI		= _T("XGMESLogic\\MELTMag\\CMELT_Feed_Data");	// 转炉炉次原料数据
const CString MELT_PROC_STATUS_CLASS_URI		= _T("XGMESLogic\\MELTMag\\CMELT_Process_Status"); // 转炉工序事件数据
const CString MELT_ADDITION_DATA_CLASS_URI	= _T("XGMESLogic\\MELTMag\\CMELT_Addition_Data"); // 转炉加料数据
const CString MELT_TOP_BLOWING_CLASS_URI		= _T("XGMESLogic\\MELTMag\\CMELT_Top_Blowing"); // 顶吹记录
const CString MELT_BOTTOM_BLOWING_CLASS_URI	= _T("XGMESLogic\\MELTMag\\CMELT_Bottom_Blowing"); // 顶吹记录
const CString MELT_OXYGEN_DATA_CLASS_URI		= _T("XGMESLogic\\MELTMag\\CMELT_Oxygen_Data"); // 定氧事件记录
const CString MELT_TEMP_DATA_CLASS_URI		= _T("XGMESLogic\\MELTMag\\CMELT_Temp_Data"); // 测温事件记录
const CString MELT_EQUIPMENT_STATUS_CLASS_URI = _T("XGMESLogic\\MELTMag\\CMELT_Equipment_Status"); // 设备状态日志
const CString MELT_PROCESS_DATA_CLASS_URI	= _T("XGMESLogic\\MELTMag\\CMELT_Process_Data"); // 炼钢过程数据
const CString MELT_DUTY_CLASS_URI	= _T("XGMESLogic\\MELTMag\\CMELT_Duty_Definition"); // 机组人员


//熔化炉工序对象URI
//熔化炉机组
const CString MELT_UNIT_URI = _T("XGMESLogic\\MELTMag\\CMELT_Unit_Mag\\S51");

// 熔化炉加工工位
const CString MELT_AREA_URI = _T("XGMESLogic\\MELTMag\\CBOF_Prod_Area\\S51");
...
const CString SCRAP_SCRAP_OBJ_URI1		= _T("XGMESLogic\\BaseDataMag\\XGStoreArea\\S84A01");	//废钢二库区
const CString SCRAP_IRON_OBJ_URI1		= _T("XGMESLogic\\BaseDataMag\\XGStoreArea\\S84A02");	//生铁二区
...
const CString QA_Sample_Type_TL = _T("TL");//转炉铁包样
...
//const CString QA_Sample_Addr_TL = _T("TL");	//转炉铁包
//Modify by llj 2011-1-18 因改造修改
