...
BEGIN_L3ACCESSCONTROL_MAP(CBaseData_Mag,CL3Object)
    ...
    L3RIGHT(BtnTappingPlanGen,"出钢计划排产按钮")//2009-03-26
...
L3RIGHT(btnDeSLanceCancel,"脱硫喷枪取消按钮")
	...
	L3RIGHT(ScrapStoreMag2,"废钢生铁原料二库管理")
	L3RIGHT(ScrapStoreOutStoreQuery2,"废钢生铁二库出库查询")
	...
	L3RIGHT(DEPDuty,"脱磷站责任人维护")
	//End

	//Add by hyh 2012-05-10
	L3RIGHT(MELTMag,"熔化炉工序")
	L3RIGHT(MenuMELTMag,"熔化炉操作菜单")
	L3RIGHT(MELTbtnConfirm,"熔化炉实绩数据确认")
	L3RIGHT(MELTCheck,"熔化炉加料数据修正")
	L3RIGHT(CheckBoxMELTInfo,"熔化炉实绩修正高级权限")//2009-04-02
	L3RIGHT(MELTAlloyYLStoreMag,"熔化炉合金原料库管理")
	L3RIGHT(MELTAlloyYLStoreMaintain,"熔化炉合金原料库料仓料种维护")
	L3RIGHT(MELTDuty,"熔化炉责任人维护")
	//End
