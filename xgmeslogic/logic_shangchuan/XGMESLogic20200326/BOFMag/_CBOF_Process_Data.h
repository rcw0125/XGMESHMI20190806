...
public:
	...
	/// <Property class="CBOF_Process_Data" name="ReBlow_Count" type="L3LONG">
	/// 补吹次数
	/// </Property>
	...
	/// <Property class="CBOF_Process_Data" name="Single_LaC" type="L3LONG">
	/// 一次拉碳
	/// </Property>
	...
	/// <Property class="CBOF_Process_Data" name="FinalSlag" type="L3STRING">
	/// 终渣状况
	/// </Property>
	DECLARE_L3PROP_STRING(FinalSlag)

	/// <Property class="CBOF_Process_Data" name="N2Pressure" type="L3FLOAT">
	/// 溅渣氮气压力
	/// </Property>
	DECLARE_L3PROP_FLOAT(N2Pressure)
};
