...
BEGIN_L3METHODMAP(CScrap_Store_Mag,MaterialStore)
	...
	L3_METHOD(CScrap_Store_Mag,"GetMaterialOnStore1",0,GetMaterialOnStore1,L3VT_RECORDSET,L3VTS_STRING)
	L3_METHOD(CScrap_Store_Mag,"ScrapCancelOutStore",0,ScrapCancelOutStore,L3VT_BOOL,L3VTS_RECORDSET)
	L3_METHOD(CScrap_Store_Mag,"ScrapCancelOutStore1",0,ScrapCancelOutStore1,L3VT_BOOL,L3VTS_RECORDSET)
	L3_METHOD(CScrap_Store_Mag,"GetScrapes",0,GetScrapes,L3VT_RECORDSET,L3VTS_NONE)
	L3_METHOD(CScrap_Store_Mag,"GetScrapes1",0,GetScrapes1,L3VT_RECORDSET,L3VTS_NONE)
	
	L3_METHOD(CScrap_Store_Mag,"SaveScrapOutDetail",0,SaveScrapOutDetail,L3VT_LONG,L3VTS_RECORDSET)
	L3_METHOD(CScrap_Store_Mag,"SaveScrapOutDetail1",0,SaveScrapOutDetail1,L3VT_LONG,L3VTS_RECORDSET)
	L3_METHOD(CScrap_Store_Mag,"ScrapOutStoreNew",0,ScrapOutStoreNew,L3VT_BOOL,L3VTS_RECORDSET)
END_L3METHODMAP()
