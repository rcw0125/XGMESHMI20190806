...
protected:
	...
	/// RET &lt;&lt;返回数据集
	/// </Method>
	L3RECORDSET GetMaterialOnStore1(L3STRING strStoreID);
	...
	/// <Method class="CScrap_Store_Mag" name="ScrapCancelOutStore1" type="L3VOID">
	/// 
	/// 废钢二库撤销出库2009-02-26
	/// ARG&gt;&gt; rsOutputInfo废钢生铁信息.必须包含MaterialType, MaterialID, Amount, StoreAreaID这几个字段。
	/// RET &lt;&lt; 成功返回TRUE；失败返回FALSE。
	/// <Param name="rsInputInfo" type="L3RECORDSET"></Param>
	/// </Method>
	L3BOOL ScrapCancelOutStore1(L3RECORDSET rsOutputInfo);
	...
	/// <Method class="CScrap_Store_Mag" name="SaveScrapOutDetail1" type="L3LONG">
	/// <Param name="rsScrap" type="L3RECORDSET"></Param>
	/// </Method>
	L3LONG SaveScrapOutDetail1(L3RECORDSET rsScrap);
	...
	/// <Param name="rsOutputInfo" type="L3RECORDSET">出库信息记录。包含MaterialType,MaterialID,Amount,AreaID等字段。</Param>
	/// </Method>
	L3BOOL ScrapOutStoreNew(L3RECORDSET rsOutputInfo);
};
