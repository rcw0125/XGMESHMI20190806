...
public:
	CRH_Prod_Area(void);
	virtual ~CRH_Prod_Area(void);

	DECLARE_L3CLASS(CRH_Prod_Area,XGMESLogic\\RHMag, Name)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CRH_Prod_Area)
...
protected:
	...
	/// <Property class="CRH_Prod_Area" name="Status" type="L3LONG">
	/// 工位状态
	/// </Property>
	DECLARE_L3PROP_LONG(Status)

	/// <Property class="CRH_Prod_Area" name="NextSteel" type="L3STRING">
	/// 下一个要到达的钢水号
	/// </Property>
	DECLARE_L3PROP_STRING(NextSteel)

	/// <Property class="CRH_Prod_Area" name="TreatNo" type="L3STRING">
	/// 当前处理号
	/// </Property>
	DECLARE_L3PROP_STRING(TreatNo)

	/// <Property class="CRH_Prod_Area" name="HeatID" type="L3STRING">
	/// 当前炉号
	/// </Property>
	DECLARE_L3PROP_STRING(HeatID)

	/// <Property class="CRH_Prod_Area" name="LadleID" type="L3STRING">
	/// 当前钢包号
	/// </Property>
	DECLARE_L3PROP_STRING(LadleID)

	/// <Property class="CRH_Prod_Area" name="SteelGradeIndex" type="L3STRING">
	/// 当前炼钢记号
	/// </Property>
	DECLARE_L3PROP_STRING(SteelGradeIndex)

	/// <Property class="CRH_Prod_Area" name="Weight" type="L3DOUBLE">
	/// 当前重量
	/// </Property>
	DECLARE_L3PROP_DOUBLE(Weight)

	/// <Property class="CRH_Prod_Area" name="Arrive_Time" type="L3DATETIME">
	/// 到达时间
	/// </Property>
	DECLARE_L3PROP_DATETIME(Arrive_Time)

	/// <Property class="CRH_Prod_Area" name="SoftBlowTime" type="L3LONG">
	/// 软吹计时
	/// </Property>
