...
IMPLEMENT_L3CLASS(CMELT_Process_Data,CL3Object,1)

BEGIN_L3PROPTABLE(CMELT_Process_Data,CL3Object)
	...
	L3PROP_LONG(ReBlow_Count)
	L3PROP_LONG(LaC_Temp)
	L3PROP_LONG(Tapping_Temp)
	L3PROP_LONG(Single_LaC)
	...
	L3PROP_STRING(FinalSlag)//2017-2-10 yuan
END_L3PROPTABLE(CMELT_Process_Data)

BEGIN_L3METHODMAP(CMELT_Process_Data,CL3Object)
END_L3METHODMAP()

BEGIN_L3EVENTSINK_MAP(CMELT_Process_Data,CL3Object)
END_L3EVENTSINK_MAP(CMELT_Process_Data)

CMELT_Process_Data::CMELT_Process_Data(void)
{
}
