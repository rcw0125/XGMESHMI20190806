// 逻辑类CMELT_Prod_Area的用户逻辑程序源文件
// 用户系统的逻辑程序应放在本文件中实现，逻辑函数的定义应放在_CMELT_Prod_Area.h中。
// 由于本文件中定义的函数均为L3集成开发环境自动生成，且在_CMELT_Prod_Area.h和
...
//当对象被卸载时，被调用
void CMELT_Prod_Area::OnUnloaded()
{
	__super::OnUnloaded();
...
/// RET << 位置编码
/// </summary>
CString CMELT_Prod_Area::GetPositionCode()
{
...
/// </summary>
BOOL CMELT_Prod_Area::OnBeforeProcess(L3RECORDSET rsParameter)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CMELT_Prod_Area::ProcessMaterials(L3RECORDSET rsMaterials,L3RECORDSET rsParameter,L3LONG* pnProcessType,L3RECORDSET *prsProducts,L3RECORDSET *prsMaterialMap)
{
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Prod_Area::OnAfterProcessed(L3RECORDSET rsMaterials,L3RECORDSET rsParameter,L3LONG nProcessType,L3RECORDSET rsProducts,L3RECORDSET rsMaterialMap)
{
	// TODO: 在此处编辑相关功能的处理代码
