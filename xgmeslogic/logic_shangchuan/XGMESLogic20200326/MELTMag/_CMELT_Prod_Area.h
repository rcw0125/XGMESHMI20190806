// 逻辑类CMELT_Prod_Area头文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。
#pragma once
#include "ProduceArea.h"

class CMELT_Prod_Area :
	public ProduceArea
{
public:
	CMELT_Prod_Area(void);
	virtual ~CMELT_Prod_Area(void);

	DECLARE_L3CLASS(CMELT_Prod_Area,XGMESLogic\\MELTMag, Name)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CMELT_Prod_Area)
