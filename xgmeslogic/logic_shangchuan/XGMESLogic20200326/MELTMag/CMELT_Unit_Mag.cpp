// 逻辑类CMELT_Unit_Mag的用户逻辑程序源文件
// 用户系统的逻辑程序应放在本文件中实现，逻辑函数的定义应放在_CMELT_Unit_Mag.h中。
// 由于本文件中定义的函数均为L3集成开发环境自动生成，且在_CMELT_Unit_Mag.h和
...
//当对象被卸载时，被调用
void CMELT_Unit_Mag::OnUnloaded()
{
	__super::OnUnloaded();
...
/// </summary>
BOOL CMELT_Unit_Mag::GetProduceAreas(CStringList& lstURIs)
{
	CString strURI;
	strURI.Format(_T("XGMESLogic\\MELTMag\\CMELT_Prod_Area\\%s"),GetIdentity().ToCString());
...
/// 得到机组前序材料缓冲区的URI
/// </summary>
CString CMELT_Unit_Mag::GetInputCache()
{
	CString strURI;
...
/// 得到机组后继材料缓冲区的URI
/// </summary>
CString CMELT_Unit_Mag::GetOutputCache()
{
	/*CString strURI;
...
/// </summary>
BOOL CMELT_Unit_Mag::OnBeforeFeedMaterials(L3RECORDSET rsMaterialInfo)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CMELT_Unit_Mag::OnAfterMaterialsFeeded(L3RECORDSET rsMaterialInfo)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// 返回机组上料记录的类型URI
/// </summary>
CString CMELT_Unit_Mag::GetFeedingLogType()
{
	return _T("");
}
...
/// RET << void
/// </summary>
void CMELT_Unit_Mag::PrepareFeedingLogs(L3RECORDSET rsFeedingLogs)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CMELT_Unit_Mag::PrepareProcessParameters(LPCTSTR lpcszArea,L3RECORDSET rsParameters)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Unit_Mag::OnAfterProcessCompleted(LPCTSTR lpcszArea,LONG nProcessType,L3RECORDSET rsProducts)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CMELT_Unit_Mag::OnBeforeDeliverMaterials(L3RECORDSET rsMaterialInfo)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Unit_Mag::OnAfterMaterialsDelivered(L3RECORDSET rsMaterialInfo)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// 返回机组产出记录的类型URI
/// </summary>
CString CMELT_Unit_Mag::GetDeliveryLogType()
{
	return _T("");
}
...
/// RET <<void
/// </summary>
void CMELT_Unit_Mag::PrepareDeliveryLogs(L3RECORDSET rsDeliveryLog)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// 返回本机组的通讯器对象的URI
/// </summary>
CString CMELT_Unit_Mag::GetCommunicator()
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Unit_Mag::PreparePlanForSending(LPCTSTR lpcszPlanType,L3RECORDSET rsPlan,L3RECORDSET* pprsSend)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Unit_Mag::OnAfterPlansSent(L3RECORDSET rsSend)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Unit_Mag::PreparePlanForCancel(LPCTSTR lpcszPlanType,L3RECORDSET rsPlan,L3RECORDSET* pprsCancel)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 成功返回TRUE；失败返回FALSE。
/// </summary>
BOOL CMELT_Unit_Mag::OnAfterPlansCanceled(L3RECORDSET rsCancel)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// </summary>
BOOL CMELT_Unit_Mag::HandleMaterialFeedingEvent(MatEnterArea *pEvt)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
/// </summary>
BOOL CMELT_Unit_Mag::HandleMaterialEnterAreaEvent(MatEnterArea *pEvt)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
/// </summary>
BOOL CMELT_Unit_Mag::HandleMaterialLeaveAreaEvent(MatLeaveArea *pEvt)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
/// </summary>
BOOL CMELT_Unit_Mag::HandleMaterialProducedEvent(MatProduced *pEvt)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// RET << 返回TRUE表示已经成功处理。返回FALSE表示使用系统缺省处理方式。
/// </summary>
BOOL CMELT_Unit_Mag::HandleUnitMeasureChangedEvent(UnitMeasure *pEvt)
{
	// TODO: 在此处编辑相关功能的处理代码
...
/// <Method class="CMELT_Unit_Mag" name="GetScrapesForDesignate" type="L3RECORDSET">
/// 获取可选废钢信息记录。返回带有废钢槽号和废钢量的记录集。
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetScrapesForDesignate()
{
	////2009-02-21*Liao
  ...
  //2016-01-27 ren
		...
		CString cssss = _T("select Scrap_Slot_ID,sum(Amount) as Amount,sum(decode(StoreAreaID,'S84A01',Amount,0)) as ScrapWT,");
	cssss += _T(" sum(Amount)-sum(decode(StoreAreaID,'S84A01',Amount,0)) as PigIronWT,LogDate from CScrap_Output_Log where Iron_Flag = 0 AND (StoreAreaID='S84A01' OR StoreAreaID='S84A02')   group by Scrap_Slot_ID,LogDate Order by LOGDATE");
...
/// 计算下一炉号
CString CMELT_Unit_Mag::CalculateNextHeatID (LPCTSTR lpcszHeatID)
{
...
/// 从计划里获取下一炉号
CString CMELT_Unit_Mag::FindNextHeatIDFromPlan()
{
...
/// 通用转炉过程状态修改函数
BOOL CMELT_Unit_Mag::ChangeBOFStatus(LONG nStatus)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	// 修改转炉状态
	//if ((nStatus < CMELT_Unit_Mag::BOFSplash) || (Status >= CMELT_Unit_Mag::BOFTapped)) //2009-01-09若出钢结束状态未到达且溅渣、倒渣信号到达时,只记录状态信息,不变更转炉状态
	//	//if ( Status >= CMELT_Unit_Mag::BOFTapped) //2009-01-09若出钢结束状态未到达且溅渣、倒渣信号到达时,只记录状态信息,不变更转炉状态
	//
	//{
	...
	if(!CreateClassPropSet(MELT_PROC_STATUS_CLASS_URI,rsStatus))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
	...
	if (nStatus == CMELT_Unit_Mag::BOFWaiting)
	...
	if(CreateNewObjects(MELT_PROC_STATUS_CLASS_URI,rsStatus) < 1)
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
...
/// 通用计划状态修改函数
BOOL CMELT_Unit_Mag::ChangePlanStatus(LPCTSTR lpcszHeatID,LPCTSTR lpcszTreatNo,LPCTSTR Status)
{
...
/// <Method class="CMELT_Unit_Mag" name="FeedIrons" type="L3BOOL">
/// 进行兑铁。使用事先指定的铁水和废钢斗进行兑铁。
/// </Method>
///2009-02-28 因邢钢实际的需要，对兑铁逻辑做大的修改，指定主原料放在兑铁之后
L3BOOL CMELT_Unit_Mag::FeedIrons()
{
	LONG nTrans;
	if(!IsInTrans())
	{
	...
	// 检查转炉状态,未作兑铁准备不允许兑铁
	if(Status != CMELT_Unit_Mag::BOFWaiting)
	{	// 已经进入兑铁状态
		Rollback(nTrans);
	...
	// 产生转炉炉次基本数据CMELT_Base_Data
	CL3RecordSetWrap rsBaseData;
	if(!CreateClassPropSet(MELT_BASE_DATA_CLASS_URI,rsBaseData))
	{
		Rollback(nTrans);
		return FALSE;
	}
	...
	CString csUri = CL3NameParser::MergeClassDomainName(MELT_DUTY_CLASS_URI,csObj);
	...
	if(CreateNewObjects(MELT_BASE_DATA_CLASS_URI,rsBaseData) < 1)
	{
		Rollback(nTrans);
		return FALSE;
	}
	...
	if(!CreateClassPropSet(MELT_PROCESS_DATA_CLASS_URI,rsProc))
	{
		Rollback(nTrans);
		return FALSE;
	}
	...
	if(!CreateNewObjects(MELT_PROCESS_DATA_CLASS_URI,rsProc))
	{
		Rollback(nTrans);
		return FALSE;
	}
	...
	// 修改转炉状态
	if(!ChangeBOFStatus(CMELT_Unit_Mag::BOFFeeding))
	{
		Rollback(nTrans);
		return FALSE;
	}
...
/// <Method class="CMELT_Unit_Mag" name="DesignateIrons" type="L3LONG">
/// 指定主原料
/// <Param name="rsIrons" type="L3RECORDSET">铁水信息,应至少包含MaterialID</Param>
///2009-02-28
/// </Method>
L3LONG CMELT_Unit_Mag::DesignateMainMaterial(L3RECORDSET rsIrons,L3RECORDSET rsReturnSteel,L3RECORDSET rsScrapes)
{
	...
	if(Status < CMELT_Unit_Mag::BOFFeeding || Status > CMELT_Unit_Mag::BOFTapping)
		return -6;
	...
	if(rsScrap.GetRowCount() > 0)
	{
			...
			//while(!rsScrapDesignated.IsEOF())
		{
			...
			if(strAreaID == _T("S84A01"))
			{	// 废钢库区
				ScrapeWeight += fW;
			}
			else if (strAreaID == _T("S84A02"))
			{	// 生铁库区
				PigIronWeight += fW;
			}
	...
	double Sn=0,Sb=0,As=0,Pb=0,Cr=0;//add by hyh 2012-04-05
	...
	{	
		...
		//end
		double fCr = rsIronsDesignated.GetFieldByName(_T("Cr")).ToDouble(); 
	...
	CString csSQL;
	csSQL.Format(csTemp,MELT_FEED_DATA_CLASS_URI,strHeatID);
	CL3RecordSetWrap rsFeedFirData;
	...
	while(!rsFeedFirData.IsEOF())
	{
		...
		//end
        //double fCr = rsIronsDesignated.GetFieldByName(_T("Cr")).ToDouble(); 
		double fCr = rsFeedFirData.GetFieldByName(_T("Cr")).ToDouble(); 
	...
	{
		if(DeleteOldObjects(MELT_FEED_DATA_CLASS_URI,rsFeedFirData) < 0)
		{
			if(nTrans > 0)
				Rollback(nTrans);
			return -17;
	...
	if(!CreateClassPropSet(MELT_FEED_DATA_CLASS_URI,rsFeedData))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return -16;
	...
	//end
    rsFeedData.SetFieldByName(_T("Cr"),CL3Variant(Pb));
	COleDateTime curTime = COleDateTime::GetCurrentTime();
	...
	if(CreateNewObjects(MELT_FEED_DATA_CLASS_URI,rsFeedData) < 1)
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return -17;
...
/// </Method>
L3BOOL CMELT_Unit_Mag::SendCastingDataToAnaL2(L3STRING strHeatID)
{
...
/// <Method class="CMELT_Unit_Mag" name="FeedElement" type="L3BOOL">
/// 向转炉中加料。
/// <Param name="rsElement" type="L3RECORDSET">加料数据，包含类型，辅料代码，料量</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::FeedElement(L3RECORDSET rsElement)
{
...
/// <Method class="CMELT_Unit_Mag" name="TopBlowing" type="L3BOOL">
/// 处理并记录转炉顶吹事件。
/// <Param name="rsBlow" type="L3RECORDSET">顶吹数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::TopBlowing(L3RECORDSET rsBlow)
{
...
/// <Method class="CMELT_Unit_Mag" name="BottomBlowing" type="L3BOOL">
/// 处理并记录底吹事件。
/// <Param name="rsBlow" type="L3RECORDSET">底吹数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::BottomBlowing(L3RECORDSET rsBlow)
{
	CL3RecordSetWrap rs = rsBlow;
	if(rs.GetRowCount() < 1)
		return FALSE;
...
/// <Method class="CMELT_Unit_Mag" name="StartBlowing" type="L3BOOL">
/// 转炉进入吹炼
/// <Param name="bMainBlowing" type="L3BOOL">主吹标识</Param>
/// <Param name="Catch_Time" type="L3DATETIME">开始时刻</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::StartBlowing(L3BOOL bMainBlowing, L3DATETIME Catch_Time)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	if(Status > CMELT_Unit_Mag::BOFBlowed || Status < CMELT_Unit_Mag::BOFFeeding)
	{	// 已经进入兑铁状态
		Rollback(nTrans);
		SetL3LastError(XGMES_ERR_BOFREFUSED);
		return FALSE;
	...
	// 修改当前状态
	if(!ChangeBOFStatus(bMainBlowing ? CMELT_Unit_Mag::BOFBlowing : CMELT_Unit_Mag::BOFBlowed))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
...
/// <Method class="CMELT_Unit_Mag" name="StopBlowing" type="L3BOOL">
/// 转炉结束吹炼
/// <Param name="Catch_Time" type="L3DATETIME">结束时刻</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::StopBlowing(L3DATETIME Catch_Time)
{
	if(Catch_Time < 100)
		Catch_Time = COleDateTime::GetCurrentTime();

	LONG nCurStatus = Status;
	if(nCurStatus == CMELT_Unit_Mag::BOFBlowing ||
		nCurStatus == CMELT_Unit_Mag::BOFBlowed)
	{	// 当前是吹炼状态，触发吹炼结束事件
		BlowingEvent = 0;
	}
...
/// <Method class="CMELT_Unit_Mag" name="SetOxygen" type="L3BOOL">
/// 处理并记录定氧事件。
/// <Param name="rsOxygen" type="L3RECORDSET">定氧数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::SetOxygen(L3RECORDSET rsOxygen)
{
...
/// <Method class="CMELT_Unit_Mag" name="SetTemperature" type="L3BOOL">
/// 处理并记录转炉测温事件。
/// <Param name="rsTemp" type="L3RECORDSET">测温数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::SetTemperature(L3RECORDSET rsTemp)
{
...
/// <Method class="CMELT_Unit_Mag" name="ChangeDeviceStatus" type="L3BOOL">
/// 修改转炉设备状态
/// <Param name="nStatus" type="L3LONG">新设备状态</Param>
/// <Param name="reason" type="L3STRING">原因</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::ChangeDeviceStatus(L3LONG nStatus,L3STRING reason)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
...
/// <Method class="CMELT_Unit_Mag" name="StartTapping" type="L3BOOL">
/// 处理出钢开始事件
/// </Method>
L3BOOL CMELT_Unit_Mag::StartTapping()
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	COleDateTime curTime = COleDateTime::GetCurrentTime();
	// 修改过程数据
	CString strProcData = CL3NameParser::MergeClassDomainName(MELT_PROCESS_DATA_CLASS_URI,HeatID);
	SetObjectPropValue(strProcData,_T("Tapping_Strat_Time"),CL3Variant(curTime));

	// 修改转炉状态
	if(!ChangeBOFStatus(CMELT_Unit_Mag::BOFTapping))
	{
...
/// <Method class="CMELT_Unit_Mag" name="CaculateLadleGrade" type="L3BOOL">
/// 计算钢包等级2008-12-28
/// </Method>
L3BOOL CMELT_Unit_Mag::CaculateLadleGrade(L3DATETIME dtTapTime,L3STRING strHeatID)
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	CString csSQL;
	csSQL.Format(_T("select * from CLadle_Use where ComFlag = 0 and bofid = 'S51'order by Input_Time asc "));
	...
	rsLadle.MoveFirst();
	CString strProcData = CL3NameParser::MergeClassDomainName(MELT_PROCESS_DATA_CLASS_URI,strHeatID);
...
/// <Method class="CMELT_Unit_Mag" name="StopTapping" type="L3BOOL">
/// 处理出钢结束事件
/// </Method>
L3BOOL CMELT_Unit_Mag::StopTapping()
{
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	// 修改转炉状态
	if(!ChangeBOFStatus(CMELT_Unit_Mag::BOFTapped))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
...
/////////////////////
	...
	//
	CString strSQL;
		strSQL.Format(_T("select LadleID from %s where HEATID= '%s'"),CLADLE_USE_URI,strHeatID);
		CL3RecordSetWrap rsLadle;
		if(!Query(strSQL,rsLadle))
		{
			if(nTrans > 0)
				Rollback(nTrans);
			return -12;
	...
	SetObjectPropValue(_T("MES\\MaterialData\\CSteel_Data\\")+strHeatID,_T("LadleID"),CL3Variant(csLadleID));
...
//	
	...
	CString strAODID = rsPlan.GetFieldByName(_T("AODID")).ToCString();
	...
	case _T('A'):
		{	// 去铸机
			strTargetCache = strAODID + _T("P01");
		}
		break;
	case _T('0'):
		{	// 去铸机
...
// 钢水下线
	//CString strArea = CL3NameParser::MergeClassDomainName(XGPRODUCEAREA_URI,GetIdentity().ToCString());//注意查看一下
...
/// <Method class="CMELT_Unit_Mag" name="Splashing" type="L3BOOL">
/// 转炉开始溅渣
/// </Method>
L3BOOL CMELT_Unit_Mag::Splashing()
{
	
		return TRUE;
}

/// <Method class="CMELT_Unit_Mag" name="Dumping" type="L3BOOL">
/// 转炉开始倒渣
/// </Method>
L3BOOL CMELT_Unit_Mag::Dumping()
{
	
		return TRUE;
}

/// <Method class="CMELT_Unit_Mag" name="Waiting" type="L3BOOL">
/// 兑铁准备，转炉进入等待状态。
/// </Method>
L3BOOL CMELT_Unit_Mag::Waiting()
{
	// 修改转炉属性
	CurTemp = 0.0;
	...
	// 检查转炉状态
	if(Status > CMELT_Unit_Mag::BOFWaiting && Status < CMELT_Unit_Mag::BOFTapped)
	{	// 已经进入兑铁状态
		Rollback(nTrans);
		SetL3LastError(XGMES_ERR_BOFREFUSED);
		return FALSE;
	...
	if(!ChangeBOFStatus(CMELT_Unit_Mag::BOFWaiting))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
...
/// <Method class="CMELT_Unit_Mag" name="GetIronsForDesignate" type="L3RECORDSET">
/// 返回可用于指定炉号的铁水信息。
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetIronsForDesignate()
{
...
/// <Method class="CMELT_Unit_Mag" name="GetInputIrons" type="L3RECORDSET">
/// 返回已经指定了的铁水信息
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetInputIrons()
{
	// 获取已指定的铁水
...
/// <Method class="CMELT_Unit_Mag" name="GetInputScrapes" type="L3RECORDSET">
/// 返回已经指定了的生铁废钢信息
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetInputScrapes()
{
...
/// <Method class="CMELT_Unit_Mag" name="OnTimer" type="L3BOOL">
/// 定时器处理
/// <Param name="uEventID" type="L3ULONG">事件ID</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::OnTimer(L3ULONG uEventID)
{
...
/// <Method class="CMELT_Unit_Mag" name="GetAddedMaterialSum" type="L3RECORDSET">
/// 返回指定炉号的加料量统计数据。
/// <Param name="HeatID" type="L3STRING">炉号</Param>
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetAddedMaterialSum(L3STRING HeatID)
{
...
/// <Method class="CMELT_Unit_Mag" name="AcceptAlloyDischargeData" type="L3RECORDSET">
/// 料仓加料数据采集
/// <Param name="HeatID" type="L3STRING">炉号</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptMaterialDischargeData(L3RECORDSET rsMaterialData)
{
	...
	while(!rsData.IsEOF())
	{
		...
		if (((Status >= CMELT_Unit_Mag::BOFTapping) || (Status <= CMELT_Unit_Mag::BOFBlowing)) && (iType == 2))
		{
		...
		while(!rsMaterial.IsEOF())
		{
			...
			if (((Status >= CMELT_Unit_Mag::BOFTapping)||(Status == CMELT_Unit_Mag::BOFWaiting)) && (iType != 9)) //2009-03-10 转炉等待状态所加物料为下炉次
			{
			...
			if (((Status >= CMELT_Unit_Mag::BOFTapping)||(Status == CMELT_Unit_Mag::BOFWaiting)) && (csPlcAddress.Find(_T("BOF_001_BOF1Alloy")) == -1)) //2009-03-10 转炉等待状态所加物料为下炉次
			{
				//当前炉次出钢开始后，从下位机系统收集的合金烘烤炉合金料数据记为下炉次消耗
				csAlloyHeatID = NextHeatID;
			}
			else if (((Status >= CMELT_Unit_Mag::BOFTapped)||(Status == CMELT_Unit_Mag::BOFWaiting)) && (csPlcAddress.Find(_T("BOF_001_BOF1Alloy")) != -1))//2009-04-27当前炉次出钢结束后，从下位机系统收集的1#合金高仓料数据记为下炉次消耗
			{
				csAlloyHeatID = NextHeatID;
			}
			else
			...
			else if ((nTopSlagFlag == 2) && (iType != 9)) //2009-04-25 添加 (iType != 9)
			{
				...
				if (((Status >= CMELT_Unit_Mag::BOFTapped)||(Status == CMELT_Unit_Mag::BOFWaiting)) && (iType != 9)) //2009-03-10 转炉等待状态所加物料为下炉次
				{
...
/// <Method class="CMELT_Unit_Mag" name="MaterialGroundDischargeData" type="L3RECORDSET">
/// 袋装合金散状料消耗
/// <Param name="HeatID" type="L3STRING">炉号</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::MaterialGroundDischargeData(L3RECORDSET rsMaterialData)
{
	CL3RecordSetWrap rsData =rsMaterialData;
	if( rsData.IsNull() || rsData.GetRowCount() < 1)
		return FALSE;
...
/// <Method class="CMELT_Unit_Mag" name="ChangeSteelGradeApp" type="L3BOOL">
/// 申请改钢
/// <Param name="Reason" type="L3STRING">原因</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::ChangeSteelGradeApp(L3STRING Reason,L3DOUBLE fWeight)
{
...
/// <Method class="CMELT_Unit_Mag" name="SteelReturn" type="L3BOOL">
///  钢水回炉申请 2009-02-28 增加炉号
/// <Param name="Reason" type="L3STRING">原因</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::SteelReturnApp(L3STRING Reason,L3DOUBLE fWeight,L3STRING strHeatID)
{
	CL3RecordSetWrap rsSteel;
	...
	//CString csHeatID =GetPropValue(_T("HeatID")).ToCString();
	CString csHeatID = strHeatID;
	CString csUri = CL3NameParser::MergeClassDomainName(MELT_BASE_DATA_CLASS_URI,csHeatID);
	CString csPreHeatID = GetObjectPropValue(csUri,_T("PreHeatID")).ToCString();
	rsSteel.SetFieldByName(_T("PreHeatID"),CL3Variant(csPreHeatID));
	rsSteel.SetFieldByName(_T("HeatID"),CL3Variant(csHeatID));
	rsSteel.SetFieldByName(_T("SteelGradeIndex"),GetObjectPropValue(csUri,_T("SteelGradeIndex")));//2008-12-30 tangyi
...
/// <Method class="CMELT_Unit_Mag" name="GetExceptHeatID" type="L3RECORDSET">
/// 获取工艺异常炉号数据。
/// <Param name="UnitID" type="L3STRING">工位</Param>
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetExceptHeatID(L3STRING UnitID)
{
...
/// <Method class="CMELT_Unit_Mag" name="SetStackData" type="L3BOOL">
/// 记录转炉炉衬维护数据
/// <Param name="rsData" type="L3RECORDSET">炉衬数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::SetStackData(L3RECORDSET rsData)
{
	...
	// 记录炉衬记录
	CL3RecordSetWrap rsLog;
	if(!CreateClassPropSet(_T("XGMESLogic\\MELTMag\\CMELT_Stack_Maintenance"),rsLog))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
	...
	rsLog.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\MELTMag\\CMELT_Stack_Maintenance"),rsLog) < 1)
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
...
/// <Method class="CMELT_Unit_Mag" name="LockData" type="L3SHORT">
/// 封锁实绩数据
...
/// </Method>
L3SHORT CMELT_Unit_Mag::LockData(L3STRING strUnitID,L3STRING strHeatID,L3STRING strTreatNo)
{
	...
	if (csUnitID.Left(2) == _T("S5"))
	{
		...
		if(csUnitID==_T("S24"))
		{
			...
			{
				double dSteelWeight=(GetObjectPropValue(_T("XGMESLogic\\MELTMag\\CMELT_Process_Data\\")+csHeatID,_T("Tapping_Weight"))).ToLong();
				if(dSteelWeight<0.1)
					return -1;
			}
		}
		//Modify end
		csURI = _T("XGMESLogic\\MELTMag\\CMELT_Base_Data\\");
		...
		//转炉手工输入合金
		CString csTempSQL = _T(" select * from CMELT_ADDITION_DATA where Name ='1' and Type ='5' and HeatID ='%s' ");
		CString csSQL;
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFStatus" type="L3BOOL">
/// 接收转炉过程状态数据 2008-12-28
/// <Param name="rsData" type="L3RECORDSET">状态数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFStatus(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	switch(BOFStatus)
	{
    	case CMELT_Unit_Mag::BOFFeeding: 
			FeedIrons();
		break;
		case CMELT_Unit_Mag::BOFBlowing: 
			StartBlowing(true, rs.GetFieldByName(_T("MesauresTime")).ToDateTime());
		break;
		case CMELT_Unit_Mag::BOFBlowed: 
		{
			StartBlowing(false, rs.GetFieldByName(_T("MesauresTime")).ToDateTime());
		}
		break;
		case CMELT_Unit_Mag::BOFTapping: 
		{
			StartTapping();
		}
		break;
		case CMELT_Unit_Mag::BOFTapped: 
			StopTapping();
		break;
		//case CMELT_Unit_Mag::BOFSplash: 
		//	Splashing();
		//break;
		//case CMELT_Unit_Mag::BOFDumping:  
		//{
		//	//2009-01-10 Begin
		...
		//		if (iSplashingTime > 0)
		//		{
		//			SetObjectPropValue(_T("XGMESLogic\\MELTMag\\CMELT_Process_Data\\")+curHeatID,_T("Splashing_Time"),CL3Variant(iSplashingTime));
		//		}
		//	}
		//	//2009-01-10 End
		//	Dumping();
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFBottomBlowData" type="L3BOOL">
/// 接收转炉底吹数据 2008-12-28
/// <Param name="rsData" type="L3RECORDSET">底吹数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFBottomBlowData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	if(!CreateClassPropSet(_T("XGMESLogic\\BOFMag\\CMELT_Bottom_Blowing"),rsBlow))
	{
		return FALSE;
	}
	...
	rsBlow.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\BOFMag\\CMELT_Bottom_Blowing"),rsBlow) < rsBlow.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFTopBlowData" type="L3BOOL">
/// 接收转炉顶吹数据 2008-12-28
/// <Param name="rsData" type="L3RECORDSET">顶吹数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFTopBlowData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	CL3RecordSetWrap rsBlow;
	if(!CreateClassPropSet(_T("XGMESLogic\\BOFMag\\CMELT_Top_Blowing"),rsBlow))
	{
		return FALSE;
	}
	...
	rsBlow.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\BOFMag\\CMELT_Top_Blowing"),rsBlow) < rsBlow.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFTappedData" type="L3BOOL">
/// 接收转炉出钢数据 2008-12-28
/// <Param name="rsData" type="L3RECORDSET">出钢数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFTappedData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFTempData" type="L3BOOL">
/// 接收转炉测温数据 2008-12-28
/// <Param name="rsData" type="L3RECORDSET">测温数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFTempData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;

	if (Status >= CMELT_Unit_Mag::BOFTapped) //出钢结束后不再收集温度数据2009-01-09
	{
		return TRUE;
	}

	CL3RecordSetWrap rsTemp;
	if(!CreateClassPropSet(_T("XGMESLogic\\MELTMag\\CMELT_Temp_Data"),rsTemp))
	{
		return FALSE;
	}
	...
	rsTemp.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\BOFMag\\CMELT_Temp_Data"),rsTemp) < rsTemp.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFOxygenData" type="L3BOOL">
/// 接收转炉定氧数据 2008-12-28
/// <Param name="rsData" type="L3RECORDSET">定氧数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFOxygenData(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
	...
	CL3RecordSetWrap rsTemp;
	if(!CreateClassPropSet(_T("XGMESLogic\\MELTMag\\CMELT_Oxygen_Data"),rsTemp))
	{
		return FALSE;
	}
	...
	rsTemp.MoveFirst();
	if(CreateNewObjects(_T("XGMESLogic\\BOFMag\\CMELT_Oxygen_Data"),rsTemp) < rsTemp.GetRowCount())
	{
		return FALSE;
	}
...
/// <Method class="CMELT_Unit_Mag" name="CalculateLcTemp" type="L3BOOL">
/// 计算拉碳温度数据(取补吹前最后一次数据,无补吹取最后一次数据) 2009-01-10
/// </Method>
L3BOOL CMELT_Unit_Mag::CalculateLcTemp()
{
	CString curHeatID = HeatID;
	if (curHeatID.GetLength() != 9)
	{
	...
	{
		csSQL.Format(_T("select Temp from CMELT_Temp_Data where HeatID = '%s' and Temp_Time < (select Change_Time from CMELT_Process_Status where HeatID = '%s' and Status = 3) order by Temp_Time desc"),curHeatID,curHeatID);
...
/// <Method class="CMELT_Unit_Mag" name="CalculateTappingTemp" type="L3BOOL">
/// 计算出钢温度数据(来源分为两处:一为倒炉测温，二为定氧时测温;出钢开始之前的最后一次测温;
/// 若出现补吹，补吹开始至出钢开始时间段未测温，则出钢温度记为未测(-1)；定氧未测温采集定氧时温度数据) 2009-01-10
/// </Method>
L3BOOL CMELT_Unit_Mag::CalculateTappingTemp()
{
	CString curHeatID = HeatID;
	if (curHeatID.GetLength() != 9)
	{
	...
	csSQL.Format(_T("select * from %s where HeatID = '%s' and Status = %d order by Change_Time desc"),
		BOF_PROC_STATUS_CLASS_URI,curHeatID,CMELT_Unit_Mag::BOFBlowed);
   ...
   csSQL.Format(_T("select Change_Time from CMELT_Process_Status where  HeatID='%s' and Status=2"),curHeatID);
   ...
   if(!Query(csSQL,rsBOFStatus)&&rsBOFStatus.GetRowCount()==1)
   {
	   ...
	   csSQL.Format(_T("select Temp_Time,Temp from CMELT_Temp_Data where HeatID = '%s' and Temp_Time > %d order by Temp_Time asc "),curHeatID,dChangeTime);
	   CL3RecordSetWrap rs;
...
/// <Method class="CMELT_Unit_Mag" name="CalculateTappedOxygenContent" type="L3BOOL">
/// 计算出钢氧含量数据(取最后一次氧含量数据) 2009-01-10
/// </Method>
L3BOOL CMELT_Unit_Mag::CalculateTappedOxygenContent()
{
	CString curHeatID = HeatID;
	if (curHeatID.GetLength() != 9)
	{
...
/// <Method class="CMELT_Unit_Mag" name="CalculateFirstLaC" type="L3BOOL">
/// 计算一次拉碳(拉碳温度等于出钢温度且无补吹及拉碳调料（轻烧白云石、石灰）信号的，视为一次拉碳) 2009-01-10
/// </Method>
L3BOOL CMELT_Unit_Mag::CalculateFirstLaC()
{
	CString curHeatID = HeatID;
	if (curHeatID.GetLength() != 9)
	{
...
/// <Method class="CMELT_Unit_Mag" name="CalculateDefaultSmeltPeriod" type="L3BOOL">
/// 计算缺省冶炼周期 2009-01-14
/// </Method>
L3BOOL CMELT_Unit_Mag::CalculateDefaultSmeltPeriod()
{
	CString curHeatID = HeatID;
	if (curHeatID.GetLength() != 9)
	{
...
/// 获取上一炉号
CString CMELT_Unit_Mag::GetPreviousHeatID(LPCTSTR lpcszHeatID)
{
	...
	else
	{
		...
		CString csSQL;
		csSQL.Format(_T("select max(HeatID) as HeatID from CMELT_Process_Data where substr(HeatID,1,4) ='%s'"),cssubHeatID);
		CL3RecordSetWrap rs;
		if(!Query(csSQL,rs) || rs.IsNull() || rs.GetRowCount() < 1)
			return _T("");
		rs.MoveFirst();
...
/// <Param name="Reason" type="L3STRING">原因</Param>
/// </Method>
L3RECORDSET CMELT_Unit_Mag::GetPreThreeHeatID()
{
	CString csUnitID = GetIdentity().ToCString();
	CString csBOFID = csUnitID.Mid(2,1);
	CString csTempSQL =_T("select * from (select HeatID from CMELT_Base_Data where substr(HeatID,2,1) = '%s'  order by  PRODUCTIONDATE desc) where rownum < 5");
	CString csSQL;
...
/// <Method class="CMELT_Unit_Mag" name="AcceptBOFRemainSlag" type="L3BOOL">
/// 接收转炉留渣数据 2016-08-11
/// <Param name="rsData" type="L3RECORDSET">留渣数据</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::AcceptBOFRemainSlag(L3RECORDSET rsData)
{
	CL3RecordSetWrap rs = rsData;
	if(rs.GetRowCount() < 1)
		return TRUE;
...
/// <Method class="CMELT_Unit_Mag" name="MeltStart" type="L3BOOL">
/// 熔化炉处理开始
/// <Param name="rsData" type="L3RECORDSET">熔化炉处理开始</Param>
/// </Method>
	L3BOOL CMELT_Unit_Mag::MeltStart()
  {
	LONG nTrans = 0;
	if(!IsInTrans())
	{
	...
	// 修改当前状态
	/*if(!ChangeBOFStatus(bMainBlowing ? CMELT_Unit_Mag::BOFBlowing : CMELT_Unit_Mag::BOFReBlowing))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
	...
	// 修改当前状态
	if(!ChangeBOFStatus(CMELT_Unit_Mag::BOFBlowing))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
...
/// <Method class="CMELT_Unit_Mag" name="MeltEnd" type="L3BOOL">
/// 熔化炉处理结束
/// <Param name="MeltEnd" type="L3DATETIME">结束时刻</Param>
/// </Method>
L3BOOL CMELT_Unit_Mag::MeltEnd()
{
	//if(Catch_Time < 100)
	//	Catch_Time = COleDateTime::GetCurrentTime();
	...
	// 检查MELT状态2009-01-02 tangyi
	if(( Status < CMELT_Unit_Mag::BOFBlowing)||(Status >CMELT_Unit_Mag::BOFBlowing))
	{	// 
		Rollback(nTrans);
		SetL3LastError(XGMES_ERR_BOFREFUSED);
		return FALSE;
	...
	// 修改当前状态
	if(!ChangeBOFStatus(CMELT_Unit_Mag::BOFBlowed))
	{
		if(nTrans > 0)
			Rollback(nTrans);
		return FALSE;
