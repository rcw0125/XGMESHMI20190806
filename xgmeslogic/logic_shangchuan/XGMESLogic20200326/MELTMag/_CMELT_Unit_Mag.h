...
class CMELT_Unit_Mag :
	public ProduceUnit
{
public:
	CMELT_Unit_Mag(void);
	virtual ~CMELT_Unit_Mag(void);

	DECLARE_L3CLASS(CMELT_Unit_Mag,XGMESLogic\\MELTMag, Name)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CMELT_Unit_Mag)
...
protected:
	/// <Property class="CMELT_Unit_Mag" name="HeatID" type="L3STRING">
	/// 当前炉号
	/// </Property>
	...
	/// <Property class="CMELT_Unit_Mag" name="Status" type="L3LONG">
	/// 当前状态
	/// </Property>
	DECLARE_L3PROP_LONG(Status)

	/// <Property class="CMELT_Unit_Mag" name="LanceAge" type="L3LONG">
	/// 枪龄
	/// </Property>
	...
	/// <Property class="CMELT_Unit_Mag" name="FurnaceAge" type="L3LONG">
	/// 炉龄
	/// </Property>
	DECLARE_L3PROP_LONG(FurnaceAge)

	/// <Property class="CMELT_Unit_Mag" name="Campaign" type="L3LONG">
	/// 炉役
	/// </Property>
	DECLARE_L3PROP_LONG(Campaign)

	/// <Property class="CMELT_Unit_Mag" name="Addition_Type" type="L3LONG">
	/// 当前加料类型
	/// </Property>
	DECLARE_L3PROP_LONG(Addition_Type)

	/// <Property class="CMELT_Unit_Mag" name="TopFlow" type="L3DOUBLE">
	/// 顶吹流量
	/// </Property>
	DECLARE_L3PROP_DOUBLE(TopFlow)

	/// <Property class="CMELT_Unit_Mag" name="TopPressure" type="L3DOUBLE">
	/// 顶吹压力
	/// </Property>
	DECLARE_L3PROP_DOUBLE(TopPressure)

	/// <Property class="CMELT_Unit_Mag" name="BottomFlow1" type="L3DOUBLE">
	/// 底吹流量1
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomFlow1)

	/// <Property class="CMELT_Unit_Mag" name="BottomPressure1" type="L3DOUBLE">
	/// 底吹压力1
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomPressure1)

	/// <Property class="CMELT_Unit_Mag" name="BottomFlow2" type="L3DOUBLE">
	/// 底吹流量2
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomFlow2)

	/// <Property class="CMELT_Unit_Mag" name="BottomPressure2" type="L3DOUBLE">
	/// 底吹压力2
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomPressure2)

	/// <Property class="CMELT_Unit_Mag" name="BottomFlow3" type="L3DOUBLE">
	/// 底吹流量3
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomFlow3)

	/// <Property class="CMELT_Unit_Mag" name="BottomPressure3" type="L3DOUBLE">
	/// 底吹压力3
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomPressure3)

	/// <Property class="CMELT_Unit_Mag" name="BottomFlow4" type="L3DOUBLE">
	/// 底吹流量4
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomFlow4)

	/// <Property class="CMELT_Unit_Mag" name="BottomPressure4" type="L3DOUBLE">
	/// 底吹压力4
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomPressure4)

	/// <Property class="CMELT_Unit_Mag" name="BottomFlow5" type="L3DOUBLE">
	/// 底吹流量5
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomFlow5)

	/// <Property class="CMELT_Unit_Mag" name="BottomPressure5" type="L3DOUBLE">
	/// 底吹压力5
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomPressure5)

	/// <Property class="CMELT_Unit_Mag" name="BottomFlow6" type="L3DOUBLE">
	/// 底吹流量6
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomFlow6)

	/// <Property class="CMELT_Unit_Mag" name="BottomPressure6" type="L3DOUBLE">
	/// 底吹压力6
	/// </Property>
	DECLARE_L3PROP_DOUBLE(BottomPressure6)

	/// <Property class="CMELT_Unit_Mag" name="BlowTotalTime" type="L3DOUBLE">
	/// 总吹炼时间
	/// </Property>
	DECLARE_L3PROP_LONG(BlowTotalTime)

	/// <Property class="CMELT_Unit_Mag" name="BlowThisTime" type="L3DOUBLE">
	/// 本次时间
	/// </Property>
	DECLARE_L3PROP_LONG(BlowThisTime)

	/// <Property class="CMELT_Unit_Mag" name="BlowingEvent" type="L3LONG">
	...
	/// <Property class="CMELT_Unit_Mag" name="ReSampleEvent" type="L3LONG">
	/// 重新取样事件
	/// </Property>
	DECLARE_L3PROP_LONG(ReSampleEvent)

	/// <Property class="CMELT_Unit_Mag" name="UndoApplyEvent" type="L3LONG">
	/// 委托单回退事件
	/// </Property>
	DECLARE_L3PROP_LONG(UndoApplyEvent)

	/// <Property class="CMELT_Unit_Mag" name="ReSampleHeatID" type="L3STRING">
	/// 重取样通知炉号
	/// </Property>
	DECLARE_L3PROP_STRING(ReSampleHeatID)

	/// <Property class="CMELT_Unit_Mag" name="StartProcessTime" type="L3STRING">
	/// 处理开始时间
	/// </Property>
	DECLARE_L3PROP_STRING(StartProcessTime)//2008-12-26


	/// <Property class="CMELT_Unit_Mag" name="Taphole_Life" type="L3LONG">
	/// 出钢口寿命
	/// </Property>
	DECLARE_L3PROP_LONG(Taphole_Life)

	/// <Property class="CMELT_Unit_Mag" name="Equip_Status" type="L3LONG">
	/// 当前状态
	/// </Property> 2009-03-02设备状态 tangyi
	DECLARE_L3PROP_LONG(Equip_Status)

	/// <Property class="CMELT_Unit_Mag" name="Plan_Count" type="L3LONG">
	///计划数
	/// </Property> 2009-03-02设备状态 tangyi
