// 逻辑类CMELT_Feed_Data头文件
// 本文件是由L3集成开发环境自动生成，在没有充分了解本文件的内容前，请不要随意修改本文件中的内容
// 否则可能带来严重后果。
#pragma once

class CMELT_Feed_Data :
	public CL3Object
{
public:
	CMELT_Feed_Data(void);
	virtual ~CMELT_Feed_Data(void);

	DECLARE_L3CLASS(CMELT_Feed_Data,XGMESLogic\\MELTMag, GUID)
	DECLARE_L3PROPTABLE()
	DECLARE_L3METHODMAP(CMELT_Feed_Data)
	...
	/// <Property class="CMELT_Feed_Data" name="HeatID" type="L3STRING">
	/// 炉号
	/// </Property>
	DECLARE_L3PROP_STRING(HeatID)

	/// <Property class="CMELT_Feed_Data" name="IronWeight" type="L3FLOAT">
	/// 铁水量
	/// </Property>
	DECLARE_L3PROP_FLOAT(IronWeight)

	/// <Property class="CMELT_Feed_Data" name="ScrapWeight" type="L3FLOAT">
	/// 废钢量
	/// </Property>
	DECLARE_L3PROP_FLOAT(ScrapWeight)

	/// <Property class="CMELT_Feed_Data" name="PigIronWeight" type="L3FLOAT">
	/// 
	/// 生铁块量
	/// 
	/// </Property>
	...
	/// <Property class="CMELT_Feed_Data" name="Return_Steel_Weight" type="L3FLOAT">
	/// 
	/// 回炉钢量
	/// 
	/// </Property>
	...
	/// <Property class="CMELT_Feed_Data" name="C" type="L3FLOAT">
	/// 碳成分值
	/// </Property>
	DECLARE_L3PROP_FLOAT(C)

	/// <Property class="CMELT_Feed_Data" name="Si" type="L3FLOAT">
	/// 硅成分值
	/// </Property>
	DECLARE_L3PROP_FLOAT(Si)

	/// <Property class="CMELT_Feed_Data" name="Mn" type="L3FLOAT">
	/// 锰成分值
	/// </Property>
	DECLARE_L3PROP_FLOAT(Mn)

	/// <Property class="CMELT_Feed_Data" name="P" type="L3FLOAT">
	/// 磷成分值
	/// </Property>
	DECLARE_L3PROP_FLOAT(P)

	/// <Property class="CMELT_Feed_Data" name="S" type="L3FLOAT">
	/// 硫成分值
	/// </Property>
	DECLARE_L3PROP_FLOAT(S)

	/// <Property class="CMELT_Feed_Data" name="Ti" type="L3FLOAT">
	/// 钛成分值
	/// </Property>
	DECLARE_L3PROP_FLOAT(Ti)

	//add by hyh 2012-04-05
	/// <Property class="CMELT_Feed_Data" name="Sn" type="L3FLOAT">
	/// </Property>
	DECLARE_L3PROP_FLOAT(Sn)

	/// <Property class="CMELT_Feed_Data" name="Sb" type="L3FLOAT">
	/// </Property>
	DECLARE_L3PROP_FLOAT(Sb)

	/// <Property class="CMELT_Feed_Data" name="As" type="L3FLOAT">
	/// </Property>
	DECLARE_L3PROP_FLOAT(As)

	/// <Property class="CMELT_Feed_Data" name="Pb" type="L3FLOAT">
	/// </Property>
	...
	/// <Property class="CMELT_Feed_Data" name="IronTemp" type="L3LONG">
	/// 铁水温度
	/// </Property>
	DECLARE_L3PROP_LONG(IronTemp)

	/// <Property class="CMELT_Feed_Data" name="LogTime" type="L3DATETIME">
	/// 指定主原料时间2009-03-03
	/// </Property>
	DECLARE_L3PROP_DATETIME(LogTime)

	/// <Property class="CMELT_Feed_Data" name="Return_SteelGrade" type="L3STRING">
	/// 回炉钢钢种2009-03-03
	/// </Property>
