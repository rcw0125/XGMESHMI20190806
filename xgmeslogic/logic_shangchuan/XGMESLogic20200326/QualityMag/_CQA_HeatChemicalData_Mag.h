...
public:
	...
	/// <Method class="CQA_HeatChemicalData_Mag" name="GetSysYearNew" type="CString">
	/// 计算年
	/// <Param name=无</Param>
	/// </Method>
    CString GetSysCurYearNew();
	...
	/// <Method class="CQA_HeatChemicalData_Mag" name="CalIronLadleSampleCode" type="CString">
	/// 计算转炉铁包样编码  and by yuan  2018-07-03
	/// <Param name="csSampleAddr" type="LPCTSTR">取样地点(混铁炉)</Param>
	/// <Param name="csSampleType" type="LPCTSTR">试样类别</Param>
	/// <Param name="csIronLadleNo" type="LPCTSTR">铁包</Param>
	/// </Method>
	CString  CalBofIronLadleSampleCode(LPCTSTR csSampleAddr,LPCTSTR csSampleType,LPCTSTR csIronLadleNo);
