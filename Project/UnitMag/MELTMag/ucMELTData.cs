...
{
    public partial class ucMELTData : UserControl
    {
        public ucMELTData()
        {
            InitializeComponent();
        ...
        public void RefreshContent()
        {
            ...
            if (strUnitType == "2")
            {
                ...
                dsArrivleCCMSteel.SourceCondition = "Position ='S91P01' order by Idx";

                dbxSteelGradeIndex.DataObject = "XGMESLogic\\MELTMag\\CMELT_Unit_Mag\\S51";
                dbxSteelGradeIndex.DataProperty = "SteelGradeIndex";

                dbxHeatID.DataObject = "XGMESLogic\\MELTMag\\CMELT_Unit_Mag\\S51";
                dbxHeatID.DataProperty = "HeatID";

                Adapter.set_URIParameters("BOFID", m_UnitID);
                object objTemp = null;
                Adapter.Session.Get("XGMESLogic\\MELTMag\\CMELT_Unit_Mag\\" + m_UnitID, "HeatID", ref objTemp);
                string HeatID = objTemp != null ? objTemp.ToString() : "";
                Adapter.set_URIParameters("HeatID", HeatID);
                objTemp = null;
                Adapter.Session.Get("XGMESLogic\\MELTMag\\CMELT_Unit_Mag\\" + m_UnitID, "SteelGradeIndex", ref objTemp);
