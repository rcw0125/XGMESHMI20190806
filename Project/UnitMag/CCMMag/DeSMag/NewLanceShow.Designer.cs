namespace UnitMag.DeSMag
{
    partial class NewLanceShow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tpNewLance.Controls.Add(this.cmbVendor);
            this.tpNewLance.Controls.Add(this.txtLanceNo);
            ...
            // cmbVendor
            // 
            this.cmbVendor.DataSource = this.dsLanceVendor;
            ...
            this.Name = "NewLanceShow";
            this.Text = "新增喷枪";
            this.Load += new System.EventHandler(this.NewLanceShow_Load);
