...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <xsl:element name ="ufinterface">
      <xsl:attribute name ="billtype">TSWQ</xsl:attribute>
      ...
      <xsl:attribute name ="proc">update</xsl:attribute>
      <xsl:attribute name ="receiver">101</xsl:attribute>
      <xsl:attribute name ="replace">Y</xsl:attribute>
      ...
      <xsl:element name ="bill">
        ...
        <xsl:element name ="bill_head">
          <xsl:element name="header">
            ...
            <xsl:element name ="vprodserialnum">
              <xsl:value-of select="NewDataSet/M/vprodserialnum"/>
            </xsl:element>
